...
def upgrade() -> None:
    ...
    op.create_index('ix_message_status_message_id', 'message_status', ['message_id'], unique=False)
    op.create_index('ix_message_status_user_id', 'message_status', ['user_id'], unique=False)
    ...
    op.create_index('ix_room_invitations_receiver_id', 'room_invitations', ['receiver_id'], unique=False)
    op.create_index('ix_room_invitations_sender_id', 'room_invitations', ['sender_id'], unique=False)
